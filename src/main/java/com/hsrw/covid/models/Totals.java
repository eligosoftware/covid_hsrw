...
public class Totals implements Serializable {
    ...
    public Totals(Date forDate, int newCases, int newDeaths, int newActive, int newRecovered, double fatalityRate, Date updatedAt, int totalCases, int totalDeaths, int totalActive, int totalRecovered) {
